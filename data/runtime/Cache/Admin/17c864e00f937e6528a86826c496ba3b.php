...
<head>
	<meta charset="utf-8"/>
	<title><?php echo L('ADMIN_CENTER');?>管理系统</title>
	<meta name="author" content="DeathGhost" />
	<link rel="stylesheet" type="text/css" href="/admin/themes/simplebootx/Public/assets/login/css/style.css" />
	<style>
...
<dl class="admin_login">
	<dt>
		<strong><?php echo L('ADMIN_CENTER');?>管理系统</strong>
	...
	<dd>
		<input type="button" value="<?php echo L('LOGIN');?>" class="submit_btn" /><br/>
...
<script src="/admin/themes/simplebootx/Public/assets/login/js/Particleground.js" ></script>
...
<script>
	...
	$(document).ready(function() {
		...
		function submit_login(){
			...
			$.ajax({
				type: 'POST',
				url: "/index.php?g=Admin&m=Public&a=dologin",
				dataType: 'json',
