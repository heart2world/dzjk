    ...
    function getIndexDay(obj,ind){
        ...
        for( var i = calendarDate[ind].monthStart;i>0;i-- ){
            ...
            if($.inArray(nowDate,calendarDate[ind].opt.rest)!=-1){
                riliHtml += '<div class="ht-rili-td ht-rili-td-disabled" style="height:70px;" data-date="'+ dataDateStr
                ...
                riliHtml += '<div class="ht-rili-td ht-rili-td-disabled" style="height:70px;" data-date="'+ dataDateStr
                    ...
                    +'<ul class="miao_info"><li>特惠活动 :秒杀</li><li>秒杀价 :成人￥'+value.c_money+'儿童￥'+value.e_money
                    +'</li><li>秒杀数量 :'+value.num
                    +'</li><li>秒杀时间 :'+value.seckill_time
                    +'</li></ul>'
                    +'<span class="ht-rili-day">'+ (k + 1)
                    +'</span><span class="ht-rili-money" style="color:#BFC4CA" data-c_money="'+ value.c_money
                    +'" data-e_money="'+ value.e_money+'">&yen;'+ value.c_money +'<br>&yen;'+ value.e_money+'</span></div>';
                ...
                riliHtml += '<div class="ht-rili-td ht-rili-td-disabled" style="height:70px;" data-date="'+ dataDateStr
                    ...
                    +'<ul class="miao_info"><li>特惠活动 :限时促销</li><li>促销价 :成人￥'+value.c_money +';儿童￥'+value.e_money
                    +'</li><li>促销数量 :'+value.num
                    +'</li><li>开始时间 :'+value.limit_start_time
                    +'</li><li>结束时间 :'+value.limit_end_time+'</li></ul>'
                    +'<span class="ht-rili-day">'+ (k + 1)
                    +'</span><span class="ht-rili-money"  style="color:#BFC4CA" data-c_money="'+ value.c_money
                    +'" data-e_money="'+ value.e_money+'">&yen;'+ value.c_money +'<br>&yen;'+ value.e_money+'</span></div>';
            }else{
                riliHtml += '<div class="ht-rili-td ht-rili-td-disabled" style="height:70px;" data-date="'+ dataDateStr
                    +'"><ul class="miao_info"><li>当日票价: 成人￥'+calendarDate[ind].opt.c_money+';儿童￥'+calendarDate[ind].opt.e_money
                    +'</li><li>预售票数 :'+calendarDate[ind].opt.poll+'</li></ul><span class="ht-rili-day">'+ (calendarDate[ind].lastDays - i + 1)
                    +'</span><span class="ht-rili-money" style="color:#BFC4CA">&yen;'+ calendarDate[ind].opt.c_money +'<br>&yen;'+ calendarDate[ind].opt.e_money+'</span></div>';
            }
        ...
        for( var k = 0;k<calendarDate[ind].days;k++ ){
            ...
            for( var d in calendarDate[ind].opt.data ){
                ...
                if( flag ){
                    ...
                    if($.inArray(nowDate,calendarDate[ind].opt.rest)!=-1){
                        if(nowDate==str){
                            riliHtml += '<div class="ht-rili-td ht-rili-td-disabled ht-rili-td-active" style="height:70px;" data-date="'+ dataDateStr
                                +'"><span class="ht-rili-day">'+ (k + 1)
                                +'</span><span class="ht-rili-money" style="color:#BFC4CA">休 <input style="margin-right:-15px" data-date="'+ dataDateStr
                                +'" data-c_money="'+ calendarDate[ind].opt.c_money
                                +'" data-e_money="'+calendarDate[ind].opt.e_money+'" type="checkbox" name="c_time"/></span></div>';
                            break;
                        }else{
                            riliHtml += '<div class="ht-rili-td ht-rili-td-disabled" style="height:70px;" data-date="'+ dataDateStr
                                +'"><span class="ht-rili-day">'+ (k + 1)
                        ...
                        if(nowDate==str){
                            ...
                            for(var t=0;t<value.length;t++){
                                string+= '<li>特惠活动 :秒杀</li><li>秒杀价 :成人￥'+value[t].c_money+';儿童￥'+value[t].e_money
                                    +'</li><li>秒杀数量 :'+value[t].num
                                    +'</li><li>秒杀时间 :'+value[t].seckill_time
                                    +'</li>'
                            }
                            riliHtml += '<div class="ht-rili-td ht-rili-td-onclick ht-rili-td-active" style="height:70px;" data-date="'+ dataDateStr
                                +'"><span class="miao" >秒</span>'
                                +'<ul class="miao_info">'+string+'</ul>'
                                +'<span class="ht-rili-day">'+ (k + 1)
                                +'</span><span class="ht-rili-money"  >&yen;'+ value[0].c_money +'<br>&yen;'+ value[0].e_money+' <input style="margin-right:-15px" data-date="'+ dataDateStr
                                +'" data-c_money="'+ value[0].c_money
                                +'" data-e_money="'+ value[0].e_money+'" data-num="'+ value[0].num
                            ...
                            riliHtml += '<div class="ht-rili-td ht-rili-td-onclick" style="height:70px;" ><span class="miao" >秒</span>'
                                +'<ul class="miao_info">'+string+'</ul>'
                                +'<span class="ht-rili-day">'+ (k + 1)
                                +'</span><span class="ht-rili-money">&yen;'+ value[0].c_money +'<br>&yen;'+ value[0].e_money+' <input style="margin-right:-15px" data-c_money="'+ value[0].c_money
                                +'" data-e_money="'+ value[0].e_money+'" data-date="'+ dataDateStr
                        ...
                        if(nowDate==str){
                            ...
                            riliHtml += '<div class="ht-rili-td ht-rili-td-onclick ht-rili-td-active" style="height:70px;" data-date="'+ dataDateStr
                                +'"><span class="miao" >限</span>'
                                +'<ul class="miao_info"><li>特惠活动 :限时促销</li><li>促销价 :成人￥'+value[0].c_money +';儿童￥'+value[0].e_money
                            ...
                            var value=get_array(nowDate,calendarDate[ind].opt.limit);
                            riliHtml += '<div class="ht-rili-td ht-rili-td-onclick" style="height:70px;" ><span class="miao" >限</span>'
                                +'<ul class="miao_info"><li>特惠活动 :限时促销</li><li>促销价 :成人￥'+value[0].c_money +';儿童￥'+value[0].e_money
                                +'</li><li>促销数量 :'+value[0].num
                                +'</li><li>开始时间 :'+value[0].limit_start_time
                                +'</li><li>结束时间 :'+value[0].limit_end_time+'</li></ul>'
                                +'<span class="ht-rili-day">'+ (k + 1)
                                +'</span><span class="ht-rili-money" >&yen;'+ value[0].c_money +'<br>&yen;'+ value[0].e_money+' <input style="margin-right:-15px" data-c_money="'+ value.c_money
                                +'" data-e_money="'+ value[0].e_money+'" data-date="'+ dataDateStr
                                +'" data-num="'+ value[0].num
                                +'" type="checkbox" name="c_time"/></span></div>';
                            break;
                        ...
                        if(nowDate==str){
                            ...
                            riliHtml += '<div class="ht-rili-td ht-rili-td-onclick ht-rili-td-active" style="height:70px;">'
                                +'<ul class="miao_info"><li>当日票价 :成人￥'+value[0].c_money +';儿童￥'+value[0].e_money
                                +'</li><li>预售票数 :'+value1[0].num+'</li></ul>'
                                +'<span class="ht-rili-day">'+ (k + 1)
                                +'</span><span class="ht-rili-money"  >&yen;'+ value[0].c_money +'<br>&yen;'+ value[0].e_money+' <input style="margin-right:-15px" data-date="'+ dataDateStr
                                +'" data-c_money="'+ value[0].c_money
                                +'" data-e_money="'+ value[0].e_money+'" data-num="'+ value1[0].num
                                +'" type="checkbox" name="c_time"/></span></div>';
                            break;
                        }else{
                            var value=get_array(nowDate,calendarDate[ind].opt.special_price);
                            var value1=get_array(nowDate,calendarDate[ind].opt.special_num);
                            riliHtml += '<div class="ht-rili-td ht-rili-td-onclick" style="height:70px;">'
                                +'<ul class="miao_info"><li>当日票价 :成人￥'+value[0].c_money +';儿童￥'+value[0].e_money
                                +'</li><li>预售票数 :'+value1.num+'</li></ul>'
                                +'<span class="ht-rili-day">'+ (k + 1)
                                +'</span><span class="ht-rili-money" >&yen;'+ value[0].c_money +'<br>&yen;'+ value[0].e_money+' <input style="margin-right:-15px" data-c_money="'+ value.c_money
                                +'" data-e_money="'+ value[0].e_money+'" data-date="'+ dataDateStr
                                +'" data-num="'+ value[0].num
                        ...
                        if(nowDate==str){
                            ...
                            riliHtml += '<div class="ht-rili-td ht-rili-td-onclick ht-rili-td-active" style="height:70px;">'
                                ...
                                +'</span><span class="ht-rili-money"  >&yen;'+ value[0].c_money +'<br>&yen;'+ value[0].e_money+' <input style="margin-right:-15px" data-date="'+ dataDateStr
                                +'" data-c_money="'+ value[0].c_money
                                +'" data-e_money="'+ value[0].e_money+'" data-num="'+ calendarDate[ind].opt.poll
                                +'" type="checkbox" name="c_time"/></span></div>';
                            break;
                        }else{
                            var value=get_array(nowDate,calendarDate[ind].opt.special_price);
                        ...
                        if(nowDate==str){
                            ...
                            riliHtml += '<div class="ht-rili-td ht-rili-td-onclick ht-rili-td-active" style="height:70px;">'
                                +'<ul class="miao_info"><li>当日票价 :成人￥'+calendarDate[ind].opt.c_money
                                +';儿童￥'+calendarDate[ind].opt.e_money+'</li><li>预售票数 :'+value[0].num+'</li></ul>'
                                +'<span class="ht-rili-day">'+ (k + 1)
                                +'</span><span class="ht-rili-money"  >&yen;'+ calendarDate[ind].opt.c_money +'<br>&yen;'+calendarDate[ind].opt.e_money+' <input style="margin-right:-15px" data-date="'+ dataDateStr
                                +'" data-c_money="'+ calendarDate[ind].opt.c_money
                                +'" data-e_money="'+ calendarDate[ind].opt.e_money
                                +' " data-num="'+ value[0].num
                                +'" type="checkbox" name="c_time"/></span></div>';
                            break;
                        }else{
                            ...
                            riliHtml += '<div class="ht-rili-td ht-rili-td-onclick" style="height:70px;">'
                                ...
                                +';儿童￥'+calendarDate[ind].opt.e_money+'</li><li>预售票数 :'+value[0].num+'</li></ul>'
                                +'<span class="ht-rili-day">'+ (k + 1)
                                +'</span><span class="ht-rili-money" >&yen;'+ calendarDate[ind].opt.c_money +'<br>&yen;'+calendarDate[ind].opt.e_money+' <input style="margin-right:-15px" data-c_money="'+ calendarDate[ind].opt.c_money
                                +'" data-e_money="'+calendarDate[ind].opt.e_money+'" data-date="'+ dataDateStr
                                +'" data-num="'+ value[0].num
                                +'" type="checkbox" name="c_time"/></span></div>';
                            break;
                        }
                        ...
                        //判断是否是当天
                        if(nowDate==str){
                            riliHtml += '<div class="ht-rili-td ht-rili-onclick ht-rili-td-active" style="height:70px;" data-date='
                                + dataDateStr +'">'
                                +'<ul class="miao_info"><li>当日票价 :成人￥'+calendarDate[ind].opt.c_money
                                +';儿童￥'+calendarDate[ind].opt.e_money+'</li><li>预售票数 :'+calendarDate[ind].opt.poll+'</li></ul>'
                                +'<span class="ht-rili-day">'+ (k + 1)
                                +'</span><span class="ht-rili-money" >&yen;'+ calendarDate[ind].opt.c_money +'<br>&yen;'+calendarDate[ind].opt.e_money+' <input style="margin-right:-15px" data-date="'+ dataDateStr
                                +'" data-c_money="'+ calendarDate[ind].opt.c_money
                                +'" data-e_money="'+calendarDate[ind].opt.e_money
                            ...
                            riliHtml += '<div class="ht-rili-td ht-rili-onclick" style="height:70px;"><ul class="miao_info"><li>当日票价 :成人￥'+calendarDate[ind].opt.c_money
                                +';儿童￥'+calendarDate[ind].opt.e_money+'</li><li>预售票数 :'+calendarDate[ind].opt.poll+'</li></ul><span class="ht-rili-day">'+ (k + 1)
                                +'</span><span class="ht-rili-money" >&yen;'+ calendarDate[ind].opt.c_money
                                +'<br>&yen;'+calendarDate[ind].opt.e_money+' <input style="margin-right:-15px" data-c_money="'+ calendarDate[ind].opt.c_money
                                +'" data-e_money="'+calendarDate[ind].opt.e_money+'" data-date="'+ dataDateStr
                                +'" data-num="'+ calendarDate[ind].opt.poll
                                +'" type="checkbox" name="c_time"/></span></div>';
                            break;
            ...
            if( !flag ){
                ...
                if($.inArray(nowDate,calendarDate[ind].opt.rest)!=-1){
                    ...
                    riliHtml += '<div class="ht-rili-td ht-rili-td-disabled" style="height:70px;" data-date="'+ dataDateStr
                        ...
                        +'<ul class="miao_info">'+string+'</ul>'
                        +'<span class="ht-rili-day">'+ (k + 1)
                        +'</span><span class="ht-rili-money" style="color:#BFC4CA">&yen;'+ value[0].c_money +'<br>&yen;'+ value[0].e_money+'</span></div>';
                }else if(is_array(nowDate,calendarDate[ind].opt.limit)){
                    var value=get_array(nowDate,calendarDate[ind].opt.limit);
                    riliHtml += '<div class="ht-rili-td ht-rili-td-disabled" style="height:70px;" data-date="'+ dataDateStr
                        +'"><span class="miao" >限</span>'
                        ...
                        +'<span class="ht-rili-day">'+ (k + 1)
                        +'</span><span class="ht-rili-money"  style="color:#BFC4CA" data-c_money="'+ value[0].c_money
                        +'">&yen;'+ value[0].c_money +'<br>&yen;'+ value[0].e_money+'</span></div>';
                }else{
                    riliHtml += '<div class="ht-rili-td ht-rili-td-disabled" style="height:70px;" data-date="'+ dataDateStr
                        +'"><ul class="miao_info"><li>当日票价 :成人￥'+calendarDate[ind].opt.c_money
                        +';儿童￥'+calendarDate[ind].opt.e_money+'</li><li>预售票数 :'+calendarDate[ind].opt.poll
                        +'</li></ul><span class="ht-rili-day">'+ (k + 1)
                        +'</span><span class="ht-rili-money" style="color:#BFC4CA">&yen;'+ calendarDate[ind].opt.c_money +'<br>&yen;'+calendarDate[ind].opt.e_money+'</span></div>';
                }
            }
        }
        ...
        for( var j = 0;j<(42 - calendarDate[ind].days - calendarDate[ind].monthStart);j++ ){//42-已占用表格数=剩余表格敿
            ...
            riliHtml += '<div class="ht-rili-td ht-rili-td-disabled" style="height:70px;" data-date="'+ dataDateStr +'"><span class="ht-rili-day">'+ (j + 1) +'</span><span class="ht-rili-money"></span></div>';
        }
        if(obj){
