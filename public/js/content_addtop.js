...
authkey 参数密钥，验证args
**/
function flashupload(uploadid, name, textareaid, funcName, args, module, catid, authkey,type) {
    var args = args ? '&args=' + args : '';
    var setting = '&module=' + module;
    Wind.use("artDialog","iframeTools",function(){
        art.dialog.open(GV.DIMAUB+'index.php?a=swfupload&m=asset&g=asset&filetype='+type + args + setting, {
        title: name,
        id: uploadid,
        width: '650px',
        height: '420px',
