...
class AliSms{
    ...
    private $accessKeyId = 'xxxxxxxxxxxx';

    // Access Access Key Secret

    private $accessKeySecret = 'xxxxxxxxxxxxxxxxxxxxx';
    ...
    private $templateCode = 'xxxxxxxxxxxxx';

    public function __construct($cofig = array(),$templateCode) {

        $cofig = array (

            'accessKeyId' => 'LTAITtW1QDxoijGb',

            'accessKeySecret' => 'S9qEyc37cexM5RFYiOQw0Hf8TKcBh7',
    ...
    public function send_verify($mobile, $verify_code) {
        ...
        $params = array (   //此处作了修改
            ...
            'TemplateParam' => '{"name":"' . $verify_code . '"}' //替换成自己的模板
