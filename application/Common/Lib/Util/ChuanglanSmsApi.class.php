...
class ChuanglanSmsApi {
	...
	function __construct($username,$password){
		$this->chuanglan_config['api_send_url'] = 'http://222.73.117.156/msg/HttpBatchSendSM';
		//创蓝短信余额查询接口URL, 如无必要，该参数可不用修改
		$this->chuanglan_config['api_balance_query_url'] = 'http://222.73.117.156/msg/QueryBalance';
		//创蓝账号
		$this->chuanglan_config['api_account']	= $username;
		//创蓝密码
		$this->chuanglan_config['api_password']	= $password;
	}
	/**
	 * 发送短信
	 *
